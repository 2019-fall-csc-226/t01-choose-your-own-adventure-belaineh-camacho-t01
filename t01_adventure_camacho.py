...
if direction =="East":
    print( "Congratulations! You have found gold! ")
    sleep(delay)

elif direction == "North":
    print("It becomes night time.")
    print("You gather up your supplies and get ready for the night")
    print("Some wolves come by an urinate all over your stuff then eat your face.")
    dead = True

else:
    print("you discover an exit and notice lights in the distance")

if dead == True:
    print("Oh no you have died! Try harder next time! Press green button to try again. ")
